...
## <p align="center">![alt text](https://github.com/Abenezer-Baheru/AirBnB_clone/blob/main/hbnb.png)</p>
...
- Clone this repository: ```git clone "https://github.com/Abenezer-Baheru/AirBnB_clone.git"```
